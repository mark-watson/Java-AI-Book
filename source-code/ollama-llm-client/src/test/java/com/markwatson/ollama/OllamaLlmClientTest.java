...
class OllamaLlmClientTest {
    ...
    @Test
    @DisplayName("Basic completion — translate English to French")
    void testCompletion() throws Exception {
        String r = OllamaLlmClient.getCompletion(
                "Translate the following English text to French: 'Hello, how are you?'",
                "gemma3:1b");
        System.out.println("completion: " + r);
        assertNotNull(r, "Completion response should not be null");
        assertFalse(r.isBlank(), "Completion response should not be blank");
    }
    ...
    void testTwoShotTemplate() throws Exception {
        ...
        assertNotNull(r, "Two-shot response should not be null");
        assertFalse(r.isBlank(), "Two-shot response should not be blank");
    }

    @Test
    @DisplayName("Summarization of a paragraph about Jupiter")
    void testSummarization() throws Exception {
        ...
        assertNotNull(r, "Summarization response should not be null");
        assertFalse(r.isBlank(), "Summarization response should not be blank");
    }
}
