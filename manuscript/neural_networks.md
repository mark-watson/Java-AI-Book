...
Dear reader, the material in this chapter is **dated**. While it still correctly describes the basics of how neural networks work, techniques that I used in the 1980s and early 1990s. I keep this older material more out of historical interest. That said, when using modern Large Language Model tech as we saw in earlier chapters, it is still a good thing to understand the basics of now neural networks are built and used.
