...
You should fetch the data just one time:
...
public class WordNetAndOpenNlpExample {
  ...
  static public Map<String, List<List<String>>> getHypernyms(String s) throws JWNLException {
  ...
  static public Map<String, List<List<String>>> getSynonyms(String s) throws JWNLException {
...
WordNet is a powerful tool for automating natural language processing but it is now easy to work with. I hope that with this simple example that you are now motivated to dive in deeper and consider using WordNet for your projects, where it is appropriate to do so.
